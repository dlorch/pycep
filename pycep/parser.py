...
def suite(source, totuple=False):
    ...
    because it is *not left-factored*. Consider the following example where both
    ...
    The issue with this production is that the recursive-descent parser could
    go down the first path, return with a success and never consider the second
    path.
