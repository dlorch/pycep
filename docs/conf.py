...
# -*- coding: utf-8 -*-
#
# PyCep documentation build configuration file, created by
...
# Method ordering by source, not alphabetically
...
latex_documents = [
  (master_doc, 'PyCep.tex', 'PyCep Documentation',
   'Daniel Lorch', 'manual'),
]
...
man_pages = [
    (master_doc, 'pycep', 'PyCep Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PyCep', 'PyCep Documentation',
   author, 'PyCep', 'One line description of project.',
   'Miscellaneous'),
]
